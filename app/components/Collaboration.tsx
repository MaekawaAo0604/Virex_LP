export default function Collaboration() {
  const collaborations = [
    {
      title: "アイデア段階の「お試し開発（PoC）」を一緒に形にする",
      content: `「こういう業務、AIで自動化できないかな？」
「このプロセス、いつも人間が判断しているけど、ルールとAIでだいぶ圧縮できそう」

そんなラフな相談から、小さめのPoCプランを切り出し、
1〜2か月で"まず試してみる用"のツールを一緒に作ります。

案件というより"共同実験"に近いイメージのものが多いです。`,
    },
    {
      title: "AISENのPoCを自社で試してみる",
      content: `AISENのようなお試しツールを、自社でテスト導入してみたい。
実際の業務メールでどれくらいタスク整理がうまくいくか試したい。

こういった「実験台になってくれるチーム」も歓迎しています。`,
    },
    {
      title: "次のPoC候補を一緒に考える",
